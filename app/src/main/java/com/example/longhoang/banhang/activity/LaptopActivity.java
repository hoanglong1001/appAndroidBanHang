...
import com.example.longhoang.banhang.adapter.LaptopAdapter;
...
import static com.example.longhoang.banhang.R.drawable.error;
...
public class LaptopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CheckConnection.haveNetworkConnection(getApplicationContext())) {
            ...
            CheckConnection.showToast_Short(getApplicationContext(), "Kiểm tra lại kết nới");
            finish();
        }
    }
                ...
                if (response != null && response.length() != 2) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            Tenlaptop = jsonObject.getString("ten");
                            Gialaptop = jsonObject.getInt("gia");
                            Hinhanhlaptop = jsonObject.getString("hinhanh");
                            Motalaptop = jsonObject.getString("mota");
                            idsplaptop = jsonObject.getInt("idloaisanpham");
                            manglaptop.add(new Sanpham(id,Tenlaptop,Hinhanhlaptop,Gialaptop,Motalaptop,idsplaptop));
