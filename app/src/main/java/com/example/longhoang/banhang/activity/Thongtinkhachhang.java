...
import static com.example.longhoang.banhang.ultil.CheckConnection.showToast_Short;
...
public class Thongtinkhachhang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CheckConnection.haveNetworkConnection(getApplicationContext())) {
            ...
            showToast_Short(getApplicationContext(), "Kiểm tra lại kết nối");
        }
    }
        ...
        btnxacnhan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ten.length() > 0 && sdt.length() > 0 && email.length() > 0) {
                                ...
                                final StringRequest request = new StringRequest(Request.Method.POST, Server.Duongdanchitietdonhang, new Response.Listener<String>() {
                                    ...
                                    public void onResponse(String response) {
                                        if (response.equals("1")) {
                                            ...
                                            showToast_Short(getApplicationContext(), "Thêm giỏ hàng thành công");
                                            Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                                            startActivity(intent);
                                            showToast_Short(getApplicationContext(), "Tiếp tục mua hàng");
                                        } else {
                                            CheckConnection.showToast_Short(getApplicationContext(), "Lỗi dữ liệu giỏ hàng");
                                        }
                                    }
                    ...
                    showToast_Short(getApplicationContext(), "Kiểm tra lại dữ liệu");
                }
            }
        });
    }
