...
import com.example.longhoang.banhang.activity.MainActivity;
...
/**
 * Created by Long Hoang on 4/6/2019.
 */
...
public class GiohangAdapter extends BaseAdapter{
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.giohang,null);
        ...
        viewHolder.btnplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                com.example.longhoang.banhang.activity.Giohang.EvenUltil();
                if (slmoinhat > 9) {
